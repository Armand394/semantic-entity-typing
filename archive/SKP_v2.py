...
"""
TWO WAY (DIRECT) CHANGES OF SEMANTIC KNOWLEDGE PROCESS - SKP V2
"""
...
data_2hop_path = os.path.join(project_folder, "data", "FB15kET_sample_s_v2")
...
et_train_new.to_csv(os.path.join(data_2hop_path, 'ET_train.txt'), sep='\t', header=None, index=False)
kg_train_new.to_csv(os.path.join(data_2hop_path, 'KG_train.txt'), sep='\t', header=None, index=False)
